...
This project is part of The Odin Project curriculum. It focuses on building a weather application that retrieves and displays real-time weather data from an external API.

The goal was to practice working with asynchronous JavaScript, API requests, and dynamic DOM updates.
